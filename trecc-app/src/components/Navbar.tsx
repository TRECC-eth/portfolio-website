  ...
  return (
    <div className="fixed top-6 left-0 w-full z-50 flex justify-center px-6 pointer-events-none">
      ...
      >
        ...
        {/* Right CTA Button */}
        <button className="bg-chrome text-black px-6 py-2 rounded-full text-sm font-bold hover:brightness-110 transition-all shadow-[0_0_15px_rgba(255,255,255,0.2)]">
          Launch App
        </button>
      </motion.nav>
    </div>
