...
export default function HeroSlide() {
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center px-4 sm:px-6 relative overflow-hidden bg-black">
      <div
        ref={vantaRef}
      ...
      <div className="relative z-10 max-w-6xl text-center w-full pointer-events-none">
        ...
        <h1 className="text-chrome font-['Montserrat'] font-medium tracking-tight leading-tight mb-6 sm:mb-8 text-3xl min-[400px]:text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem]">
        ...
        <p className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-10 sm:mb-12 font-light text-[#8A8D93] leading-relaxed px-2 sm:px-0">
