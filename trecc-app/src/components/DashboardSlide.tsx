        ...
        <div className="w-full h-full overflow-hidden flex flex-col relative rounded-2xl">
          ...
          <div className="flex flex-1 min-h-0 overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col bg-transparent relative overflow-hidden">
              ...
              <div className="absolute right-0 top-0 bottom-10 w-11 sm:w-16 flex flex-col justify-between py-5 md:py-8 text-[9px] sm:text-[10px] md:text-[11px] text-white/30 items-end pr-2.5 md:pr-4 z-10 font-mono tabular-nums shrink-0 font-medium">
                <span>$45.0k</span><span>$40.0k</span><span>$35.0k</span><span>$30.0k</span><span>$25.0k</span>
              </div>

              <div className="absolute left-0 right-0 bottom-0 h-9 sm:h-10 border-t border-white/[0.04] flex justify-between items-center px-3 md:px-8 text-[9px] sm:text-[10px] md:text-[11px] text-white/30 z-10 font-mono tabular-nums pr-11 sm:pr-[4.5rem] shrink-0 font-medium bg-black/10">
