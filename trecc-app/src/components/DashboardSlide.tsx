  ...
  return (
    ...
    <div className="h-screen w-full flex flex-col items-center justify-start pt-[5.5rem] md:pt-[120px] pb-4 md:pb-12 px-4 md:px-6 relative overflow-hidden box-border">
      ...
      <motion.div
        ...
        className="w-full max-w-[940px] md:max-w-[1080px] h-[56vh] sm:h-auto md:flex-1 min-h-[320px] sm:min-h-[420px] md:min-h-[500px] max-h-[56vh] sm:max-h-[calc(100vh-9.5rem)] md:max-h-[720px] flex flex-col shadow-[0_30px_80px_rgba(0,0,0,0.9)] rounded-2xl relative z-10 border border-white/[0.08] bg-[#09090B]/95 backdrop-blur-2xl"
      >
