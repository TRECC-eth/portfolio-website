...
export default function DashboardSlide({ step, active = true }: DashboardProps) {
  ...
  return (
    ...
    <div className="h-screen w-full flex flex-col items-center justify-start pt-24 md:pt-[120px] pb-4 md:pb-12 px-4 md:px-6 relative overflow-hidden box-border">
      ...
      <div className="min-h-[3rem] md:min-h-[4.5rem] w-full flex items-center justify-center relative shrink-0 mb-3 md:mb-10 z-30 px-5 pt-2 md:px-4 md:pt-0">
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: step === 1 ? 1 : 0, y: step === 1 ? 0 : -10 }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} className="absolute max-w-4xl">
          <h2 className="text-chrome font-medium text-[1.35rem] sm:text-3xl md:text-5xl tracking-tight text-center leading-tight">
      ...
      >
        <div className="w-full h-full overflow-hidden flex flex-col relative rounded-2xl">
          ...
          {/* Header */}
          <div className="h-9 md:h-16 border-b border-white/[0.06] flex items-center justify-between gap-2 px-2.5 md:px-8 bg-gradient-to-b from-white/[0.03] to-transparent shrink-0 z-20">
            <div className="flex items-center gap-6 min-w-0">
              <span className="text-white font-medium text-[10px] sm:text-base md:text-lg flex items-center gap-1.5 tracking-tight truncate">
            ...
            <div className="flex items-center gap-3 md:gap-4 shrink-0">
              ...
              <motion.span className="text-white bg-black/50 px-1.5 py-0.5 rounded-lg border border-white/[0.08] text-[8px] sm:text-sm md:text-base font-mono tabular-nums shadow-inner">
                {activeCredit}
              </motion.span>
            </div>
          </div>
          ...
          <div className="flex flex-1 min-h-0 overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col bg-transparent relative overflow-hidden">
              ...
              <div className="absolute right-0 top-0 bottom-7 sm:bottom-10 w-8 sm:w-16 flex flex-col justify-between py-2.5 md:py-8 text-[6px] sm:text-[10px] md:text-[11px] text-white/30 items-end pr-1.5 md:pr-4 z-10 font-mono tabular-nums shrink-0 font-medium">
                <span>$45.0k</span><span>$40.0k</span><span>$35.0k</span><span>$30.0k</span><span>$25.0k</span>
              </div>

              <div className="absolute left-0 right-0 bottom-0 h-6 sm:h-10 border-t border-white/[0.04] flex justify-between items-center px-2 md:px-8 text-[6px] sm:text-[10px] md:text-[11px] text-white/30 z-10 font-mono tabular-nums pr-8 sm:pr-[4.5rem] shrink-0 font-medium bg-black/10">
              ...
              <div className="relative z-30 p-1.5 sm:p-6 md:p-8 pb-1 sm:pb-4 md:pb-5 flex justify-between items-end shrink-0">
                <div>
                  ...
                  <AnimatePresence mode="popLayout">
                    <motion.div
                      ...
                      className="text-[0.95rem] sm:text-4xl md:text-[56px] font-medium tracking-tight tabular-nums"
              ...
              <div className="flex-1 relative mt-0 mr-8 sm:mr-[4.5rem] mb-6 sm:mb-12 md:mb-14 min-h-0 pl-1.5 md:pl-8">
